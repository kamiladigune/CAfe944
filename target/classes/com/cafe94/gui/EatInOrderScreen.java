...
import com.cafe94.domain.Item; // Use domain Item
import com.cafe94.domain.Table; // Use domain Table
import com.cafe94.domain.User;
import com.cafe94.domain.EatIn; // Return type of placeEatInOrder
import com.cafe94.persistence.ITableRepository; // Assumed needed
...
import javafx.util.StringConverter; // For table combo box
...
public class EatInOrderScreen implements Main.NeedsMainApp {
    ...
    public static class OrderItem {
        ...
        public BigDecimal getPrice() {
            // Assuming getPrice returns double
            ...
            @Override public String toString(Table table) {
                return table == null ? null :
                       String.format("T%d (%d Seats, %s)",
                           ...
                           table.getStatus()); // Show status
            }
            @Override public Table fromString(String string) { return null; }
        });
    }

    private void loadAvailableTables() {
        try {
            // Maybe add repo/service method getAvailableTables()?
            List<Table> tables = tableRepository.findAll();
            // Filter here if needed, e.g., only AVAILABLE tables
