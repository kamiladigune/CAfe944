...
public class MenuViewScreen implements Main.NeedsMainApp {
    ...
    public void initialize() {
        ...
        // Assume specialDisplayBox and specialDetailsLabel exist in FXML
        // Their setup (style, title) can be done in FXML or here
        configureSpecialDisplayBox(); // If complex setup needed
        ...
        if (titleLabel != null) {
            titleLabel.setText("Menu"); // Or get from FXML
        }
    }
    ...
    private void configureSpecialDisplayBox() {
        ...
        if (specialDisplayBox != null) {
            ...
            // Style can be set here or preferably via CSS/FXML
            // specialDisplayBox.setStyle("-fx-background-color: #FFFFE0; ...");
        }
    ...
    private void loadMenuAndSpecial() {
        ...
        try {
            ...
            // Assuming Item has boolean isDailySpecial()
        ...
        try {
            ...
            if (specials.isEmpty()) {
                ...
                // Display first special (adjust if multiple needed)
